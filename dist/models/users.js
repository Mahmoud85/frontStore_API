...
var UserStore = /** @class */ (function () {
    ...
    UserStore.prototype.index = function () {
        return __awaiter(this, void 0, void 0, function () {
            var sqlQuery, conn, result, usersList, error_1;
    ...
    UserStore.prototype.show = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var sqlQuery, conn, result, user, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("Could not find User with user name: ".concat(id, ".\n ").concat(error_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    UserStore.prototype.findByMail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var sqlQuery, conn, result, user, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("Could not find User with user name: ".concat(email, ".\n ").concat(error_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    UserStore.prototype.create = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, hash, result, newUser, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        error_4 = _a.sent();
                        throw new Error("Error creating new User(".concat(user.first_name, " ").concat(user.last_name, ").\n ").concat(error_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
