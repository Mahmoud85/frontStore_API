...
var ProductStore = /** @class */ (function () {
    ...
    ProductStore.prototype.index = function () {
        return __awaiter(this, void 0, void 0, function () {
            var sqlQuery, conn, result, error_1;
    ...
    ProductStore.prototype.show = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var sqlQuery, conn, result, product, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("Could not find Product with id: ".concat(id, ".\n ").concat(error_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("Error unable to create product(".concat(product.name, ", ").concat(product.price, ", ").concat(product.category, ").\n ").concat(error_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    ProductStore.prototype.clearAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
